 ...
 */
export const endLog = new rpc.RequestType<WithProgressId<EndLogParams>, EndLogResult, void, void>(
  'evaluation/endLog'
);
 ...
 */
export const completeQuery = new rpc.RequestType<EvaluationResult, Record<string, any>, void, void>(
