...
const SummaryItem = ({
  ...
  <>
    ...
    <span className="vscode-codeql__analysis-item">
      <SummaryItemDownload analysisSummary={analysisSummary} analysisResults={analysisResults} />
    </span>
...
const AnalysesResultsDescription = ({
  ...
  const downloadsMessage = (
    <>
      <VerticalSpace size={1} />
      Some results haven&apos;t been downloaded automatically because of their size or because
      enough were downloaded already. Download them manually from the list above if you want to see
      them here.
    </>
  );
...
const AnalysesResults = ({
  ...
  return (
    <>
      ...
      <AnalysesResultsDescription queryResult={queryResult} analysesResults={analysesResults} />

      <VerticalSpace size={2} />
      <RepositoriesSearch filterValue={filterValue} setFilterValue={setFilterValue} />
