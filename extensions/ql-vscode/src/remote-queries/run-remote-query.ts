...
export async function getRepositories(): Promise<string[] | undefined> {
  const quickPickItems = [
    ...createQuickPickItemsForPredefinedLists(),
    ...createQuickPickItemsForRepoLists()
  ];
...
function createQuickPickItemsForRepoLists(): RepoListQuickPickItem[] {
...
function createQuickPickItemsForPredefinedLists(): RepoListQuickPickItem[] {
  const top10Item: RepoListQuickPickItem = {
    label: '$(star) Top 10',
    repoList: [],
    preDefinedListName: 'top10',
    alwaysShow: true
  };

  const top100Item: RepoListQuickPickItem = {
    label: '$(star) Top 100',
    repoList: [],
    preDefinedListName: 'top100',
    alwaysShow: true
  };

  return [top10Item, top100Item];
}
